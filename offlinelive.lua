-- script viet hoa By http://tranhba.com  c¨n cø nhµ ch¬i cÊp bËc , gia t¨ng dông hé ®Ých kinh nghiÖm # khÊu trõ c¸ch tuyÕn bµy qu¶n thêi gian # gia t¨ng phóc duyªn 
-- script viet hoa By http://tranhba.com  kinh nghiÖm mçi 5 phót gia t¨ng mét lÇn # c¸ch tuyÕn thêi gian mçi trinh gi¶m bít 1 , phóc duyªn mét giê gia t¨ng mét lÇn 
IncludeLib("PARTNER"); 
IncludeLib("TONG"); 
Include( "\\script\\global\\fuyuan.lua" );
Include( "\\script\\global\\baijuwanhead.lua" );

-- script viet hoa By http://tranhba.com  2008 gi¸ng sinh ho¹t ®éng ë tuyÕn bµy qu¶n ®¹t ®­îc mµu ®á hép quµ ®Ých ®Çu v¨n kiÖn 
-- script viet hoa By http://tranhba.com Include("\\script\\item\\shengdan_jieri\\200811\\red_box.lua");

-- script viet hoa By http://tranhba.com  2006 n¨m lÔ quèc kh¸nh ho¹t ®éng ®Çu v¨n kiÖn 
...
-- script viet hoa By http://tranhba.com tinhpn 20100805: VLMC 
...
-- script viet hoa By http://tranhba.com  lÊy ®­îc ®Þnh lóc khÝ ®Ých sè l­îng 
function gettimercount() 
return 4 
end 

-- script viet hoa By http://tranhba.com  lÊy ®­îc ®Þnh lóc khÝ ®Ých hµm sè 
...
-- script viet hoa By http://tranhba.com  lÊy ®­îc thi hµnh thêi gian gian c¸ch # tr¸nh ®Õm # 
function gettimerinterval(index) 
if (index == 0) then 
return AEXP_INTERVAL -- script viet hoa By http://tranhba.com  thªm kinh nghiÖm #5 phót 
elseif (index == 1) then 
return 60 * FRAME2TIME -- script viet hoa By http://tranhba.com  gi¶m thêi gian # mçi phót 
elseif (index == 2) then 
return 60 * 60 * FRAME2TIME -- script viet hoa By http://tranhba.com  dÉn phóc nguyªn #1 giê 
elseif (index == 3) then 
return AEXP_INTERVAL -- script viet hoa By http://tranhba.com  thªm kü n¨ng ®é thuÇn thôc #5 phót 
end 
return AEXP_INTERVAL 
end 

-- script viet hoa By http://tranhba.com  lÊy ®­îc ®Þnh lóc khÝ chän h¹ng , 0 bµy tá thø 0 chu kú b¾t ®Çu thi hµnh , 1 bµy tá thø 1 chu kú b¾t ®Çu thi hµnh 
function gettimeroption(index) 
if (index == 0) then 
return 1 -- script viet hoa By http://tranhba.com  thªm kinh nghiÖm #5 phót sau nµy 
elseif (index == 1) then 
return 1 -- script viet hoa By http://tranhba.com  gi¶m thêi gian #1 phót sau nµy 
elseif (index == 2) then 
return 0 -- script viet hoa By http://tranhba.com  dÉn phóc nguyªn # lËp tøc nhËn lÊy 
elseif (index == 3) then 
return 1 -- script viet hoa By http://tranhba.com  thªm kü n¨ng ®é thuÇn thôc #5 phót 
end 
return 0 
end 

-- script viet hoa By http://tranhba.com  lÊy ®­îc cùc kú lóc kiÓm tra gian c¸ch # tr¸nh ®Õm # 
function gettimeoutinterval() 
return 60 * FRAME2TIME -- script viet hoa By http://tranhba.com  cã hay kh«ng cùc kú lóc ®Ých kiÓm tra gian c¸ch thêi gian lµ 60s 
end 
...
-- script viet hoa By http://tranhba.com  if (nHour >= 18 and nHour < 24) then 
...
-- script viet hoa By http://tranhba.com  kü n¨ng râ rµng ®Ých kinh nghiÖm cã hay kh«ng gÊp ®«i 
function skillBaijuEffect() 
local nHour = tonumber(GetLocalDate("%H")); -- script viet hoa By http://tranhba.com  lÊy ®­îc giê 
return 1; 
end; 

-- script viet hoa By http://tranhba.com  c¨n cø cÊp bËc lÊy ®­îc kinh nghiÖm 
...
nExp = 175; -- script viet hoa By http://tranhba.com  nÕu nh­ lµ ®ång b¹n , 50 cÊp h¹ ®¹t ®­îc kinh nghiÖm v× 50 cÊp ®¹t ®­îc kinh nghiÖm 1/4 
end 

if (GetProductRegion() ~= "vn") then 

-- script viet hoa By http://tranhba.com  nÕu nh­ lµ 2006 mïa xu©n lµ r¹ng s¸ng 0 ®iÓm ®Õn tèi 6 ®iÓm 2 lÇn 
if isSpringTime()==1 and nHour>=0 and nHour<18 then 
nExp = nExp * 2; 
end; 

if (IsTimeValid() == 2) then 
nExp = nExp * AEXP_FREQ * 12; -- script viet hoa By http://tranhba.com  mçi ngµy 0#00-12#00 b¹ch c©u hoµn kinh nghiÖm gÊp béi 
else 
nExp = nExp * AEXP_FREQ * 6; -- script viet hoa By http://tranhba.com  (5) phót ®¹t ®­îc ®Ých kinh nghiÖm trÞ gi¸ ( hoa ®µo ®¶o kinh nghiÖm 6 lÇn ) 
end 

else 
nExp = nExp * AEXP_FREQ * 7; -- script viet hoa By http://tranhba.com  (5) phót ®¹t ®­îc ®Ých kinh nghiÖm trÞ gi¸ () 
end 
-- script viet hoa By http://tranhba.com  cã hay kh«ng cã ®¹i cßn ®an hiÖu qu¶ , lµ cã kinh nghiÖm thªm ®­îc 
if (IsDaHuanDanValid() == 1) then 
-- script viet hoa By http://tranhba.com  cho cïng ®¹i cßn ®an kinh nghiÖm thªm ®­îc 
...
nSpecialD = 0.5*0.5; -- script viet hoa By http://tranhba.com  UNDONE by zbl t¹i sao muèn thiÕt thµnh 0.25? 
end; 
-- script viet hoa By http://tranhba.com getredbox(nSpecialD); -- script viet hoa By http://tranhba.com  lÔ gi¸ng sinh ho¹t ®éng ë tuyÕn bµy qu¶n ®¹t ®­îc mµu ®á hép quµ 
tbFunv0903:GetItemByTuoGuan(nSpecialD) 
-- script viet hoa By http://tranhba.com  gia t¨ng nhµ ch¬i kinh nghiÖm 
local nPlayerLevel = GetLevel(); 
if (nPlayerLevel >= AEXP_NEEDLEVEL) then 
local nExp, nAddExp = getofflinevalue(nPlayerLevel); 
nExp = floor(nSpecialD * nExp); 
local nEnExp = CalcEnhanceExp(nExp) -- script viet hoa By http://tranhba.com  tÝnh to¸n kinh nghiÖm thªm ®­îc 
...
nExp = floor(nSpecialD * nExp); 
PARTNER_AddExp(nPartnerIdx, nExp); -- script viet hoa By http://tranhba.com  thªm kinh nghiÖm 
end 
end 
...
-- script viet hoa By http://tranhba.com  nh÷ng chøc n¨ng kh¸c cÇn gia t¨ng bµy qu¶n kinh nghiÖm , viÕt vµo nµy 
function getAddExpValue(nExp) 
return 0 
end; 

-- script viet hoa By http://tranhba.com  gi¶m bít thêi gian 
...
-- script viet hoa By http://tranhba.com  gia t¨ng phóc duyªn 
...
-- script viet hoa By http://tranhba.com  gia t¨ng kü n¨ng ®é thuÇn thôc 
...
local nSpecialD = 1; -- script viet hoa By http://tranhba.com  kü n¨ng b¹ch c©u 1 lÇn 
if (GetTask(AEXP_SPECIAL_SKILL_TASKID) > 0) then -- script viet hoa By http://tranhba.com  ®Æc hiÖu kü n¨ng b¹ch c©u 2 lÇn 
nSpecialD = 2; 
elseif (GetTask(AEXP_SKILL_TIME_TASKID) > 0) then -- script viet hoa By http://tranhba.com  kü n¨ng râ rµng c©u lµ 1.5 
nSpecialD = 1.5 
end; 
...
-- script viet hoa By http://tranhba.com  nÕu v× 120 kü n¨ng , lµ treo ky kinh nghiÖm v× ®Þnh trÞ gi¸ 
