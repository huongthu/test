...
--  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  - 
--   nghiªm träng thanh minh # nµy v¨n kiÖn kh«ng hót tù phï chuçi 
--  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  --  - 

--   lÔ quan ch©n vèn 
--   Li_Xin 2004-8-17 
--  Include( "\\script\\global\\ÖÐÇï»î¶¯.lua" )

--  TASKID_HOLIDAY_GIFT_DATE = 160; --   nhiÖm vô thay ®æi l­îng ID of nhµ ch¬i mét lÇn cuèi cïng nhËn lÊy ngµy lÔ lÔ vËt thêi gian 
--  TASKTMPID_HOLIDAY_GIFT_DATE = 160; --   t¹m thêi nhiÖm vô thay ®æi l­îng ID of nhµ ch¬i mét lÇn cuèi cïng nhËn lÊy ngµy lÔ lÔ vËt thêi gian 
...
Include("\\script\\misc\\ex_goldequp_coin.lua");	--   ¶Ò»»»Æ½ð×°±¸½ðÅÆ
Include("\\script\\event\\jiefang_jieri\\201004\\main.lua");
Include("\\script\\event\\jiefang_jieri\\201004\\refining_iron\\Npc.lua") --   Á¶½ð»î¶¯


--   ViÖt Nam 0904 gi¶i phãng ho¹t ®éng 
...
--   ViÖt Nam 0905 sinh nhËt ho¹t ®éng 
...
--  [DinhHQ] 
--  [20110107]: dÉn t­ëng ph­¬ng anh hµo t­ëng th­ëng 
...
--   ®ãng hµo quang VLMC2011 - Modified by DinhHQ - 20110523 
tbVLMC2011_Tittle:AddDialog(tbDailog) 
tbVngToolAward:AddDialog(tbDailog) 
G_ACTIVITY:OnMessage("ClickNpc", tbDailog, nNpcIndex) 
--   b¾n ra ®èi tho¹i khu«ng 
tbDailog:AddOptEntry("Huy hoµng chi ®ªm ", onGreat_Night) 
--   tbDailog:AddOptEntry("Tham gia thÇn bÝ b¶o r­¬ng ho¹t ®éng ", BRTB_Dialog_main) 
...
--   tbDailog:AddOptEntry("Ta ®Ó ®æi 8 th¸ng ®Ých event vËt phÈm ", ExChangeItem_main) 
--   end 
tbDailog:AddOptEntry("Khai Pass r­¬ng ", ResetBox.ShowDialog, {ResetBox}) 

--  tinhpn 20101022: Event Thang 10 
--   if (Event201010:IsActive() == 1) then 
--   tbDailog:AddOptEntry("§æi 10 th¸ng ®Ých ho¹t ®éng phÇn th­ëng ", Event201010.ShowDialog, {Event201010}) 
--   end 
...
AddOwnExp(1000000); 
AddItem(6, 1, 1136, 1, 0, 0, 0); --   thªm mét giã lín tói # 
Say("Qu¸ tr©n quý # ®©y lµ ThiÕu L©m ph­¬ng tr­îng cïng Nga Mi ch­ëng m«n ®­a cho ng­¬i mét chót t©m ý .", 1,"TiÕp nhËn lÔ vËt ./OnCancel"); 
Msg2Player("Ng­¬i lÊy ®­îc <color=yellow>1000000<color> chót kinh nghiÖm cïng 1 c¸ <color=yellow> bao tiÒn l× x× <color>"); 
end; 

--   ngµy lÔ liÖt biÓu 
aryHoliday = { --   ngµy lÔ thêi gian , phï hîp ngµy lÔ thêi gian së ®iÒu hµm sè tªn , t¸i diÔn dÉn lÔ phÈm ®Ých ®Ò kú v¨n vèn 
...
--   50 cÊp trë lªn nhµ ch¬i thªm ®­a 1 c¸ “ Thiªn S¬n ngäc lé ” 
if( GetLevel() >= 50 ) then 
