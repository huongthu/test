...
function get1()
	str=
	{
		"<#> §©y chÝnh lµ ®å phæ vò khÝ quý b¸u trong vâ l©m. §å phæ vò khÝ dïng ®Ó ®óc luyÖn binh khÝ, cã c«ng dông t¨ng ®¼ng cÊp. ng­¬i cã thÓ dïng Thñy Tinh ®Ó trao ®æi, cã nhu cÇu kh«ng?",
		"<#> ChØ xem th«i/no",
		...
		"<#> ¸m KhÝ Tæng phæ. QuyÓn 1 (PhÝ tiªu) /yes8",
...
function get2()
	str=
	{
		"<#> Kú tr©n B¶o vËt cña ta cã thÓ dïng ®Ó chÕ t¹o, kh¶m n¹m, t¨ng vµ gi¶m ®¼ng cÊp trang bÞ. Kh¸ch quan cã muèn xem qua kh«ng?",
...
function yes1()
	-- Ô½ÄÏ°æ±¾¼Û¸ñ¸Ä¶¯£º
	--Say("ÉñÃØÉÌÈË£ºÄãÈ·¶¨Òª»»<color=red>ÁêÍõÇ¹¶ÍÔì²ÐÆª<color>Âð£¿ÁêÍõÇ¹¶ÍÔì²ÐÆªÐèÒª3¿Å<color=red>×ÏË®¾§<color>¡¢<color=red>2¿ÅÂÌË®¾§<color>ºÍ<color=red>1¿ÅÀ¼Ë®¾§<color>½»»»¡£",2,"È·¶¨/sure1","È¡Ïû/no")
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>L¨ng V­¬ng Th­¬ng §o¹n T¹o Tµn Biªn<color> chø? CÇn cã 1 <color=red>Tö Thñy Tinh<color>, <color=red>1 Lôc Thñy Tinh<color> vµ <color=red>1 Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure1","Hñy bá /no")
end;

function sure1()
	if ((GetItemCountEx(238)>=1) and (GetItemCountEx(239)>=1) and (GetItemCountEx(240)>=1)) then 
		Talk(1,"","Ha!Ha! Thñy Tinh ®Ñp qu¸! §©y lµ §å phæ, b¶o ®¶m cã thÓ gióp §¹i hiÖp th¨ng cÊp vò khÝ.")
	  	DelItemEx(238)
	  	DelItemEx(239)
	  	--DelItemEx(239)
	  	--DelItemEx(239)
...
function yes2()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>HuyÒn Vò Chïy §óc T¹o ThuËt<color> chø? CÇn cã 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure2","Hñy bá /no")
end;
...
function yes3()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>Long Ng©m KiÕm §o¹n T¹o §å<color> chø? CÇn 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure3","Hñy bá /no")
end;
...
function yes4()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>Gia C¸t C¬ Qu¸t MËt YÕu<color> chø? CÇn 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure4","Hñy bá /no")
end;
...
function yes5()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>LiÔu DiÖp To¸i Phong §ao. Tôy Thó Biªn<color> chø? CÇn 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure5","Hñy bá /no")
end;
...
function yes6()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>HuyÒn NguyÖt §ao Tö Kinh B¶o Lôc<color> chø? CÇn cã 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure6","Hñy bá /no")
end;
...
function yes7()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>Thiªn C¬ C«n §å Phæ<color> chø? CÇn 1 <color=red>Tö Thñy Tinh<color>, 1 <color=red>Lôc Thñy Tinh<color> vµ 1 <color=red>Lam Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure7","Hñy bá /no")
end;
...
function yes8()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>¸m KhÝ Tæng Phæ.QuyÓn 1<color> chø? CÇn cã 2 <color=red>Tö Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure8","Hñy bá /no")
end;
...
function sure8()
	if ((GetItemCountEx(239)>=2)) then 
		Talk(1,"","Ha!Ha! Thñy Tinh ®Ñp qu¸! §©y lµ §å phæ, b¶o ®¶m cã thÓ gióp §¹i hiÖp th¨ng cÊp vò khÝ.")
	  	...
	  	DelItemEx(239)
	  	AddEventItem(413)
	  	writeChapManLog("B¹n nhËn ®­îc ¸m KhÝ Tæng phæ. QuyÓn 1.")
	  	Msg2Player("B¹n nhËn ®­îc ¸m KhÝ Tæng phæ. QuyÓn 1.")
	else
	  	Talk(1,"","¸m KhÝ Tæng Phæ.QuyÓn 1 cÇn cã 2 Tö Thñy Tinh ®Ó ®æi. §¹i hiÖp h×nh nh­ ch­a ®ñ Thñy Tinh!")
	end
end;

function yes9()
	Say("§¹i hiÖp x¸c ®Þnh muèn ®æi <color=red>Uyªn ¦¬ng §ao. Khai Quang Biªn<color> chø?Uyªn ¦¬ng §ao. CÇn 1 <color=red>Tö Thñy Tinh<color> ®Ó ®æi!",2,"X¸c nhËn/sure9","Hñy bá /no")
end;
...
function buy_silk()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>B¨ng Tµm V« Cùc T¬<color> chø? <color=red>40 TiÒn §ång<color> ®æi ®­îc <color=red>1 B¨ng Tµm V« Cùc T¬<color>.",
		"<#> Sö dông/sure10",
		"<#> Hñy bá /no",
	};
...
function sure10()
	if (CalcEquiproomItemCount(4, 417, 1, 1)>=40) then 
		Talk(1,"","Ha! Ha! §· nhËn ®­îc 40 TiÒn §ång. §©y lµ <color=red>B¨ng Tµm V« Cùc T¬<color>. §¹i hiÖp xem! §¶m b¶o cã thÓ th¨ng cÊp y phôc, kh«i m·o!")
	  	...
	  	AddEventItem(415)
	  	UseSilver(1, 2, 2); -- ½ðÔª±¦¶Ò»»ÎªÍ­Ç®µÄÏûºÄÍ³¼Æ(Ö±½ÓÏûºÄµÄÔª±¦ÒøÆ±£¬ÓëÍ­Ç®¶Ò»»µÈÍ¬´¦Àí)
	  	SaveNow(); -- Á¢¼´´æÅÌ
	  	-- writeChapManLog("ÄãµÃµ½±ù²ÏÎÞ¼«Ë¿¡£")
...
function buy_stone()
	str=
	{
		"<#> Kh¸ch quan x¸c ®Þnh mua <color=red>Nam Minh Chi Tinh<color> chø? <color=red>40 TiÒn ®ång<color> ®æi ®­îc <color=red>1 Nam Minh Chi Tinh<color>.",
		"<#> Sö dông/sure11",
		"<#> Hñy bá /no",
	};
	Say(str[1],2,str[2],str[3])
...
function deal_brokenequip()
	if (ST_CheckLockState() == 1) then
		Say("Muèn söa <color=red><trang bÞ tæn h¹i><color>, cÇn ph¶i më mËt m· r­¬ng ra. R­¬ng cña b¹n trong tr¹ng th¸i ®ang ®­îc<color=red> khãa l¹i<color>! CÇn ph¶i më khãa tr­íc!", 0)
		return
	end
	Say("B¹n cã <color=red><trang bÞ tæn h¹i><color>kh«ng? Muèn söa nh­ thÕ nµo?", 2, "Ta muèn sö dông TiÒn ®ång ®Ó kh«i phôc l¹i/restore_brokenequip", "Th«i ®Ó khi kh¸c ta ®Õn söa trang bÞ!/no")	
end
...
function throw_brokenequip()
	GiveItemUI( "<trang bÞ tæn h¹i>giao diÖn thu håi", "Mêi b¹n ®Æt <trang bÞ tæn h¹i> cÇn thu håi vµo « bªn d­íi.", "on_throw_be", "no" );
end
...
function on_throw_be(nCount)
	...
	Say("<color=red><trang bÞ tæn h¹i>"..szItemName.."<color> mét khi thu håi, sÏ biÕn mÊt, ng­¬i x¸c ®Þnh muèn thu håi kh«ng?", 2, "ta x¸c ®Þnh kh«ng cÇn n÷a, h·y thu håi ®i!/#throw_be_sure("..nItemIdx..")", "§Ó ta suy nghÜ l¹i/no")
end

function throw_be_sure(nItemIdx)
	local szItemName = GetItemName(nItemIdx)
	RemoveItemByIndex(nItemIdx)
	Msg2Player("<trang bÞ tæn h¹i>"..szItemName.." §· bÞ thu håi");
...
function restore_brokenequip()
	GiveItemUI( "<trang bÞ tæn h¹i> giao diÖn phôc håi", "Xin mêi bá <trang bÞ ®· h­ háng> vµo « bªn d­íi. PhÝ cÇn söa (xu): trang bÞ phæ th«ng cÇn 1 xu, tÝm cÇn 2 xu, hoµng kim cÇn 5 xu, b¹ch kim cÇn 6 xu (söa b¹ch kim +6 trë lªn cßn cÇn thªm thiÕt huyÕt ®¬n). Chó ý: tr­íc khi tiÕn hµnh söa trang bÞ, h·y kiÓm tra hµnh trang cßn ®ñ « trèng.", "on_restore_be", "no", 1);	
end
...
function on_restore_be(nCount)
	...
	if (nQuality == 0) then
		nNeedCoin = 1;
	elseif (nQuality == 1) then -- »Æ½ð×°±¸
		nNeedCoin = 5;
	elseif (nQuality == 2) then -- ×ÏÉ«×°±¸
		nNeedCoin = 2;
	elseif (nQuality == 4) then -- °×½ð×°±¸
		nNeedCoin = 10;
	end
	
	if (nNeedCoin <= 0) then
		Say("§©y lµ trang bÞ g× vËy, ta kh«ng nhËn ra ®­îc? H·y liªn hÖ víi ng­êi cã tr¸ch nhiÖm.", 1, "Uhm/no")
		writeChapManLog("[Error]: RestoreBrokenEquip Fail. ItemQuality:"..nQuality);
		return
	end
	
	if (nCoinCount < nNeedCoin) then
		Say("Muèn phôc håi <color=red><trang bÞ tæn h¹i>"..szItemName.."<color>, cÇn"..nNeedCoin.."TiÒn ®ång. TiÒn ®ång b¹n mang theo kh«ng ®ñ, t×m vµi c¸i n÷a ®i!", 1, "HiÓu råi, ®Ó ta ®i lÊy TiÒn ®ång ®·!/no")
		return
	end
	
	if (nQuality == 4 and GetPlatinaLevel(nItemIdx) >= 6) then
		if (CalcEquiproomItemCount(6,1,2163,-1) < 1) then
			Say("ThÇn bÝ th­¬ng nh©n: Hµnh trang kh«ng cã thiÕt huyÕt ®¬n, kh«ng thÓ söa trang bÞ.", 0)
			return
		end
		...
		if (ConsumeItem(3, 1, 6, 1, 2163,-1) ~= 1) then
			...
			Say("<trang bÞ tæn h¹i>"..szItemName.." phôc håi thÊt b¹i, xin liªn hÖ ng­êi cã tr¸ch nhiÖm.", 1, "§­îc!/no")
	...
	if (PayCoin(nNeedCoin) == 1) then
		if (ITEM_BrokenEquip2Normal(nItemIdx) == 1) then
			...
			Msg2Player("Tiªu hao"..nNeedCoin.."TiÒn ®ång, <trang bÞ tæn h¹i>"..szItemName.." phôc håi thµnh c«ng, xin kiÓm tra hµnh trang");
