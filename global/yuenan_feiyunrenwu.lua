--Ô½ÄÏ·ÉÔÆÈÎÎñ:»î¶¯¿ªÊ¼ºóÐÂÈËÎï´ïµ½¹æ¶¨µÄµÈ¼¶£¨60¼¶£¬90¼¶£¬100¼¶£©£¬Ôò¿Éµ½NPC´¦ÁìÈ¡ÏàÓ¦µÄ½±Àø
--			a.	Íæ¼Ò´ïµ½60¼¶ºó£¬¿ÉÒÔµ½ÁÙ°²Ìú½³´¦(×ø±ê166/191) ¶Ô»°²¢ÁìÈ¡½±Àø£¬½±ÀøÎª¾ßÓÐÁ½¸ö
--				Òþ²ØÊôÐÔ£¨ÊôÐÔËæ»ú£©µÄÀ¶É«×°±¸Ò»¸ö(½äÖ¸»ò»¤Éí·û/ÏîÁ´»òÓñÅå/Óñïí)£»
--			b.	Íæ¼Ò´ïµ½90¼¶ºó£¬¿ÉÒÔµ½ÏåÑôÌú½³´¦(×ø±ê195/205) ¶Ô»°²¢ÁìÈ¡½±Àø,½±ÀøÎª¾ßÓÐÈý¸öÒþ²Ø
--				ÊôÐÔ£¨ÊôÐÔËæ»ú£©µÄÀ¶É«ÎäÆ÷Ò»¸ö(ÎäÆ÷ÖÖÀàÊÓÍæ¼ÒÃÅÅÉ¶ø¶¨)£»
...
V_FY_SZ_ACTIONNAME = "v_feiyun06_permanent";	-- Ô½ÄÏÓÀ¾ÃÐÔ»î¶¯
...
function v_fy_60_entrance()
	-- Say("Kim binh thÕ m¹nh nh­ th¸c lò, T­¬ng D­¬ng s¾p thÊt thñ!, Hoµng Th­îng ®· tô häp anh hïng nghÜa sü kh¾p n¬i bµn b¹c tÝnh kÕ, ®ång thêi ban tÆng 1 mãn trang bÞ tri ©n c¸c anh hïng hµo kiÖt ®¹t ®Õn cÊp 60.", 2, 
	-- "NhËn phÇn th­ëng cÊp 60/v_fy_60_next",
	-- "Nh©n tiÖn ghÐ xem th«i!/no");
end;
...
function v_fy_60_yu()	--ÁìÈ¡60¼¶µÄÏîÁ´
	...
	elseif (nSex == 1) then	-- Èç¹ûÊÇ¸öÄÐ½ÇÉ«
...
v_fy_90_tab_weapon = {
	...
	["emei"] = {"HuyÒn ThiÕt KiÕm (Nga Mi kiÕm)", "HuyÒn ThiÕt KiÕm (Nga Mi khÝ)"},
	["tangmen"] = 	 {"B¸ V­¬ngTiªu", "To¸i NguyÖt §ao", "Khæng T­íc Linh"},
	["wudu"] = {"§¹i Phong §ao (Ngò §éc ch­ëng)", "§¹i Phong §ao (Ngò §éc ®ao)"},
	["tianwang"] = {"Ph¸ Thiªn KÝch", "Ph¸ Thiªn chïy", "§¹i Phong §ao"},
	["shaolin"] = {"§¹i Phong §ao", "Kim C« Bæng"},
	["wudang"] = {"HuyÒn ThiÕt KiÕm (Vâ §ang kiÕm)", "HuyÒn ThiÕt KiÕm (Vâ §ang khÝ)"},
	["kunlun"] = {"§¹i Phong §ao", "HuyÒn ThiÕt KiÕm"},
	["gaibang"] = 	 {"Kim C« Bæng (C¸i bang ch­ëng)", "Kim C« bæng (C¸i Bang c«n)"},
	["tianren"] = {"Ph¸ Thiªn KÝch (Thiªn NhÉn kÝch)", "Ph¸ Thiªn KÝch (Thiªn NhÉn ch­ëng)"}
};
...
function v_fy_90_weapon(player_Faction, i)
	...
	elseif (player_Faction == "tianren") then
		str = "B¹n nhËn ®­îc <color=yellow>Ph¸ Thiªn KÝch<color>.";
	end;
...
function v_fy_100_entrance()
	-- Say("Kim binh thÕ m¹nh nh­ th¸c lò, T­¬ng D­¬ng s¾p thÊt thñ!, Hoµng Th­îng ®· tô häp anh hïng nghÜa sü kh¾p n¬i bµn b¹c tÝnh kÕ, ®ång thêi ban tÆng Phi V©n ThÇn M· ®Ó tri ©n c¸c vÞ anh hïng.", 2, 
