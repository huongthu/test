...
Include("\\script\\global\\bil4i3n\\bil4i3n_trang_bi_xanh_magic.lua")
...
function tiejiang_city(...)
	...
	tbDailog:AddOptEntry("Thay ®æi ®¼ng cÊp", jewel_yes);
	--tbDailog:AddOptEntry("[Trang bÞ Xanh][Lôc] Xoay thñy tinh", bilTrangBiXanh_ThayDoiMaPhap);
	--tbDailog:AddOptEntry("[Trang bÞ Xanh][Tö - Lam] N©ng cÊp, ngò hµnh", jewel_yes1);
